              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-2 text-xs font-semibold text-zinc-100 text-left focus:outline-none focus:border-zinc-700"
                  />
                </div>
                <div>
            ...
            <div className="bg-zinc-900/60 border border-zinc-800/80 rounded-xl p-3.5 space-y-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                <div className="relative flex items-center">
                  <Calendar className="w-3.5 h-3.5 text-zinc-400 absolute left-3 pointer-events-none" />
                  <input
                    type="date"
                    ...
                    className="w-full bg-zinc-900 border border-zinc-800 text-xs text-zinc-300 rounded-lg pl-9 pr-3 py-2 focus:outline-none focus:border-zinc-700"
                  />
                </div>
                <div className="relative flex items-center">
                  <input
                    ...
                    className="w-full bg-zinc-900 border border-zinc-800 text-xs text-zinc-300 rounded-lg pl-3 pr-8 py-2 focus:outline-none focus:border-zinc-700"
                  />
                  <Clock className="w-3.5 h-3.5 text-zinc-400 absolute right-3 pointer-events-none" />
                </div>
              </div>
            </div>
