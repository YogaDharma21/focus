...
export const FocusTimer: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-full max-w-2xl mx-auto w-full select-none space-y-6">
      <div className="bg-card border border-border p-1 rounded-lg flex items-center justify-between w-80 shadow-md">
        <button
      ...
      {timerMode === 'POMODORO' && previousMode !== 'STOPWATCH' && (
        <div className="flex items-center gap-2.5 px-3.5 py-1.5 rounded-full bg-secondary/90 border border-border text-xs font-mono text-muted-foreground shadow-sm animate-in fade-in duration-150 group">
