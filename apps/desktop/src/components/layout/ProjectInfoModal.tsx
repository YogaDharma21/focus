...
const PROJECT_INFO = {
  name: "Focus Desktop",
  version: "v0.0.1",
  description: "A minimalist, high-performance desktop productivity suite designed to keep you in flow state. Features open-ended Flow timers with smart break calculation, task management with subtasks, streak & distraction analytics, mood reflections, and ambient music.",
