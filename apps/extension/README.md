...
**Focus Extension** is a monochrome-themed Chrome extension that brings the core Focus experience directly into your browser. It provides Flow timers, task management, site blocking, mood journaling, and session analytics — all from a compact popup UI.
