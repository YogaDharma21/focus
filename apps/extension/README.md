...
1. **Popup** (`popup.html` + `Popup.tsx`) — The main interface users interact with. Contains tabbed navigation for timer, tasks, shield, stats, and settings. All state is persisted to `chrome.storage.local`.
