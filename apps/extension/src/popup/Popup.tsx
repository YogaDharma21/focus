...
export function Popup() {
  ...
  return (
    <div className={`w-[420px] h-[600px] flex flex-col overflow-hidden select-none font-sans relative ${
      ...
      <div className="flex-1 overflow-y-auto p-4 z-10 relative">
        {/* TIMER TAB */}
        {activeTab === "timer" && (
          <div className="flex flex-col items-center justify-between min-h-full pb-8 pt-1 gap-2.5">
