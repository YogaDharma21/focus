      ...
      <div className="relative z-10 max-w-xl w-full text-center">
        ...
        <div className="relative p-8 sm:p-12 rounded-3xl border border-white/10 dark:border-white/10 bg-white/5 dark:bg-black/20 backdrop-blur-2xl shadow-2xl transition-all duration-300">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Button asChild size="lg" className="w-full sm:w-auto font-medium px-6 gap-2 shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all">
              <Link href="/">
                <Focus className="w-4 h-4" />
                Return to Focus App
              </Link>
            </Button>
            <Button asChild variant="outline" size="lg" className="w-full sm:w-auto font-medium px-6 gap-2 border-white/10 hover:bg-white/10">
              <Link href="/">
